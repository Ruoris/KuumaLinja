...
public class LevelGeneratorMultiplayer : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (levelController.GetComponent<LevelControllerMultiplayer>().playerSpawned == false)
        {
            ...
            levelController.GetComponent<LevelControllerMultiplayer>().playerSpawned = true;
        }
        GetRooms();
    ...
    public void GeneratePoints()
    {
        ...
        levelController.GetComponent<LevelControllerMultiplayer>().floorSpawn = location;
    ...
    public void GetRooms()
    {
        ...
        for (int r = 0; r < roomCoordinates.Length; r++)
        {
            ...
            GameObject room = GetComponent<RoomGeneratorMultiplayer>().GenerateRoom(rooms[r], location, spawnXint, spawnYint, roomDoors[r], levelGenerator);
            ...
            GetComponent<RoomGeneratorMultiplayer>().GenerateFurniture(roomLayouts[r], location, rooms[r], levelGenerator);
