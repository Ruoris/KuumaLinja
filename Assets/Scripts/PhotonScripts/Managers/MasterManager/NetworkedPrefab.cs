...
public class NetworkedPrefab 
{
    ...
    {
        int extesionsionLength = System.IO.Path.GetExtension(path).Length;
        ...
        {
            return path.Substring(startIndex+ additionalLength, path.Length - (additionalLength+startIndex + extesionsionLength));
        }
